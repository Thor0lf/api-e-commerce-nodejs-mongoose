...
exports.validateUpdateUserInput = [
    ...
    (0, express_validator_1.body)('firstname').optional().isLength({ min: 2 }).withMessage('Le prénom est trop court.'),
    (0, express_validator_1.body)('lastname').optional().isLength({ min: 2 }).withMessage('Le nom est trop court.'),
];
