...
order.get('/', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
order.get('/:orderId', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
order.post('/', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
function createOrder(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return res.status(201).json({ message: `Le produit ${product === null || product === void 0 ? void 0 : product.name} a été ajouté à votre panier.` });
        }
        catch (error) {
...
function updateOrder(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return order.patch('/:orderId/add-product', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const product = yield product_1.default.findById(productId);
                    return res.status(200).json({ message: `Le produit ${product === null || product === void 0 ? void 0 : product.name} a été ajouté au panier.` });
                }
                catch (error) {
...
order.patch('/:orderId/add-product', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { orderId } = req.params;
        const { productId } = req.body;
        const existingOrder = yield order_1.default.findById(orderId);
        ...
        const validProductId = new mongoose_1.Types.ObjectId(productId);
...
order.patch('/:orderId/remove-product', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { orderId } = req.params;
        const { productId } = req.body;
        const existingOrder = yield order_1.default.findById(orderId);
        ...
        yield existingOrder.save();
        return res.status(200).json({ message: `Le produit ${product === null || product === void 0 ? void 0 : product.name} a été enlevé du panier.` });
    }
    catch (error) {
        return res.status(500).json({ message: 'Erreur lors du retrait du produit du panier.' });
    }
}));
order.patch('/:orderId/remove-products-with-same-id', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { orderId } = req.params;
        const { productId } = req.body;
        const existingOrder = yield order_1.default.findById(orderId);
        ...
        yield existingOrder.save();
        return res.status(200).json({ message: `Tous les produits ${product === null || product === void 0 ? void 0 : product.name} ont été enlevés du panier.` });
    }
    catch (error) {
        return res.status(500).json({ message: 'Erreur lors de la suppression des produits du panier.' });
    }
}));
order.delete('/:orderId', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { orderId } = req.params;
        const existingOrder = yield order_1.default.findById(orderId);
        if (!existingOrder) {
